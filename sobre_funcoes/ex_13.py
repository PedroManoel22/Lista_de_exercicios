    ...
    while True:
        try:
            ...
            if linha < 1:
                linha = 1
                print(
                    "O valor mínimo de linha é 1, como você colocou menos, vou considerar como 1"
                )

            elif linha > 20:
                linha = 20
                print(
                    "O valor máximo de linha é de 20, como você colocou a mais, vou considerar como 20"
                )
            break
        except ValueError:
            print("\033[1;31mPor favor insira um valor do tipo int\033[m")
    ...
    while True:
        try:
            ...
            if coluna < 1:
                coluna = 1
                print(
                    "O valor mínimo de coluna é 1, como você colocou menos, vou considerar como 1"
                )

            elif coluna > 20:
                coluna = 20
                print(
                    "O valor máximo de coluna é de 20, como você colocou a mais, vou considerar como 20"
                )
            break
        except ValueError:
            print("\033[1;31mPor favor insira um valor do tipo int\033[m")
...
def valida_carcteres() -> str:
    caracteres = ["+", "-", "|"]
    while True:
        caractere = input(
            'Insira qual caractere você quer para seu retângulo: ["+", "-" e "|"]: '
        )
...
def printar_retangulo(linha: int, coluna: int, caractere: str) -> None:
    if linha == coluna:
        print(
            "Você me deu dois valores iguais com isso vamos ter um quadrado, por isso irei tirar 1 de linha "
        )
        linha -= 1
