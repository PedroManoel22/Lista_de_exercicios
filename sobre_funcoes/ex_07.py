...
def valor_prestacao() -> float:
    while True:
        try:
            ...
            print("\033[1;31mPor favor insira um valor int ou float\033[m")
...
def numero_dias_atraso() -> int:
    while True:
        try:
            ...
            print("\033[1;31mPor favor insira um valor do tipo float oi int\033[m")
...
def valor_pagamento(prestacao: float, dias_atraso: int) -> str:
    if dias_atraso == 0:
