...
class Televisao:
    ...
    def aumentar_volume(self) -> None:
        ...
        if self.volume < limite:
            print("volume da tv foi aumentado!")
            self.volume += 1
    ...
    def mostrar_informacoes(self) -> None:
        print(
            f"\033[1;36mA tv está no canal {self.num_canal} e seu volume está no {self.volume}\033[m"
        )

    def mudar_canal_mais(self) -> None:
        ...
        if self.num_canal < ultimo_canal:
            ...
            print(
                f"\033[1;31mNão existe mais canais acima do canal {self.num_canal}\033[m"
            )

    def mudar_canal_menos(self) -> None:
        ...
        if self.num_canal > primeiro_canal:
            ...
            print(
                f"\033[1;31mNão existe mais canais abaixo do canal {self.num_canal}\033[m"
            )
