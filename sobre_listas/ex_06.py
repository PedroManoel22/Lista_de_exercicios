            ...
            while True:
                try:
                    ...
                    if 0 <= nota <= 10:
                        ...
                        print(
                            "\033[1;31mPor favor, insira uma nota entre 0 e 10.\033[m"
                        )

                except ValueError:
                    print(
                        "\033[1;31mPor favor, coloque um valor numérico válido.\033[m"
                    )
...
def exibir_dados(dados: list[Aluno]):
    ...
    for aluno in dados:
        ...
        print(
            f"O aluno {aluno['nome']} teve as seguintes notas: {aluno['notas']} e ficou com a média de {media:.2f}"
        )
